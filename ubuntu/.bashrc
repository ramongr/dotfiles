...
function passphrase(){
  echo c59bce5123ed0f494ebb89eb2ae97700
}

export -f passphrase

# Cleans already merged branches from git
function gitclean(){
...
export PS1='\[\e[34m\]\u\[\e[0m\] \[\e[36m\]\W\[\e[0m\]\[\e[33m\]$(__git_ps1)\[\e[0m\] » '
